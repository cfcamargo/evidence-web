            ...
            <div class="w-full flex bg-gray-primary p-4 rounded pb-10">
                <div class="w-1/3">
                    ...
                    <div class="flex flex-col py-6">
                        ...
                        <a href=""
                            class="mt-2 bg-red-primary w-32 h-8 rounded flex items-center justify-center text-white filter hover:brightness-90">Comprar</a>
                    </div>
                </div>
                <div class="flex-1">
                    <nuxt-img src="/images/sofa-home-card.png" class="w-full -mt-16" />
                </div>
            </div>
            <p class="px-4 text-red-primary italic text-lg">Oferecemos uma ampla gama de sofás para todos os gostos e
                estilos. De designs descolados a opções mais sofisticadas, temos o modelo perfeito esperando por você.</p>
        </Container>
