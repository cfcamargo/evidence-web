    ...
    <div class="flex flex-col gap-2">
        ...
        <Container>
            ...
            <div class="flex flex-col gap-4 justify-center items-center" v-else>
                ...
                <div class="py-10">
                    <q-pagination v-model="current" :max="100" :max-pages="6" ellipses direction-links unelevated
                        color="gray-primary" text-color="red-primary" active-color="red-primary" active-text-color="white"
