<template>
    <aside class="h-screen flex fixed top-0 bottom-0 flex-col bg-red-primary" :class="open ? 'w-[300px]' : 'w-[100px]'" @mouseenter="openAside" @mouseleave="closeAside">
        <div class="w-full py-8 px-2">
            <LogoWhite class="w-full max-w-[200px] mx-auto"/>
        </div>
        <div class="flex-1 flex flex-col gap-8">
            <button class="flex items-center gap-2 justify-center">
